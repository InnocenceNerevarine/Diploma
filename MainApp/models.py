...
class Product(models.Model):
    ...
    slug = AutoSlugField(unique=True, verbose_name='URL', populate_from='title')
...
class CartProduct(models.Model):
    ...
    class Meta:
        verbose_name = f'Корзина с товаром'
...
class Customer(models.Model):
    ...
    class Meta:
        verbose_name = f'Заказчик'
        verbose_name_plural = f'Заказчики'
