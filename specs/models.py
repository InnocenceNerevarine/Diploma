...
class CategoryFeature(models.Model):
    ...
    class Meta:
        ...
        verbose_name = f'Категория характеристики'
        verbose_name_plural = f'Категории характеристик'
...
class FeatureValidator(models.Model):
    ...
    class Meta:
        verbose_name = f'Валидатор значений харатеристик'
        verbose_name_plural = f'Валидатор значений харатеристики'
...
class ProductFeatures(models.Model):
    ...
    class Meta:
        verbose_name = f'Характеристика товара'
        verbose_name_plural = f'Характеристики товара'
